	     ...
	     <div class="center">
			...
			<div class="right">
				<div class="pic1">
						...
						<button class="button button1">Set Quizes</button>
				</div>
				<div class="pic2">
                                    <img src="images/42.jpg">
						<button class="button button2">View Time Table</button>
				</div>
				<div class="pic3">
                                    <img src="images/43.jpg">
					<button class="button button3">Upload Grade</button>

					
				</div>
				<div class="pic4">
                                    <img src="images/44.jpg">
					<button class="button button4">Send<br> E-mail</button>
